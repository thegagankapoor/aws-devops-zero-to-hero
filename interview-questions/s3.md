### 1. What is Amazon S3?
Amazon Simple Storage Service (Amazon S3) is a scalable cloud storage service designed to store and retrieve any amount of data from anywhere on the web. It's commonly used to store files, backups, images, videos, and more.
