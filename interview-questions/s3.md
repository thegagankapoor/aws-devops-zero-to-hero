...
S3 bucket is basically a container where you store your files (called objects), which can be files, images, videos, and more. Each object in S3 is identified by a unique key within a bucket.
